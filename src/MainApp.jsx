...
const SPARK_COLORS = ["#ff3b3b", "#ff8a8a", "#ffd65d", "#5da9ff"];
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-6 font-mono relative overflow-hidden">
      <style>{`
        ...
        @keyframes boxPulse { 0%,100%{box-shadow:0 0 20px 2px rgba(255,59,59,0.45)} 50%{box-shadow:0 0 40px 6px rgba(255,59,59,0.75)} }
        ...
        @keyframes logoGlow { 0%,100%{box-shadow:0 0 10px 2px rgba(255,59,59,0.5)} 50%{box-shadow:0 0 22px 6px rgba(255,59,59,0.85)} }
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            {profile?.role === "admin" && (
              <button onClick={onOpenAdmin} className="text-[#ff3b3b] hover:text-[#ff8a8a]" title="Admin panel">
                <Shield size={17} />
              </button>
            )}
        ...
        >
          ...
          >
            ...
            {[
              ...
              <div
                key={i}
                className="absolute w-5 h-5 border-[#ff3b3b]"
            ...
            <div className="text-center relative">
                ...
                <div
                  ...
                  style={{
                    background: result === "small"
                      ...
                      : "linear-gradient(135deg, #ff5c5c, #7a0000)",
                    color: "#fff",
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between text-[10px] text-[#ff8a8a] tracking-widest mb-1.5">
                ...
                <div className="w-full h-1.5 rounded-full bg-[#ff3b3b]/15 overflow-hidden">
                  <div
              ...
              {waitFlash ? (
                <div className="w-full flex items-center justify-center gap-2 text-[#ff8a8a] text-xs tracking-widest border border-[#ff3b3b]/50 rounded-md py-2.5" style={{ animation: "flicker 0.5s infinite" }}>
                  <Clock size={13} />
