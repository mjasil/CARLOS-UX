        ...
        <div className="flex gap-2 mb-6">
          {[
            ...
            <button
              ...
              style={{
                background: tab === id ? "linear-gradient(90deg, #ff3b3b, #a80000)" : "rgba(255,255,255,0.06)",
                ...
                {users.map((u) => (
                  <div key={u.id} className="flex items-center justify-between bg-white/5 border border-white/10 rounded-lg px-3 py-2.5">
                    ...
                    <button
                      ...
                      className="text-xs px-2.5 py-1 rounded-md border border-[#ff3b3b]/40 text-[#ff8a8a]"
                    >
              ...
              <form onSubmit={sendNotification} className="space-y-3">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-white/5 border border-white/15 rounded-lg px-3 py-2 text-white text-sm mt-1 outline-none focus:border-[#ff3b3b]/60 resize-none"
                  />
                </div>
                {notifyMsg && <p className="text-[#ff8a8a] text-xs">{notifyMsg}</p>}
                <button
                  type="submit"
                  disabled={sending}
                  className="w-full flex items-center justify-center gap-2 text-white font-semibold text-sm py-2.5 rounded-lg disabled:opacity-50"
